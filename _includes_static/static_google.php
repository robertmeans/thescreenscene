<div id="google" class="searches">
	...
	<p>Google</p>
    <div class="srs">
        <input type="text" id="sr_01" name="q" value=""> <a data-role="srcr" data-id="sr_01"><i class="fas fa-backspace"></i><a data-role="srcb" data-id="sr_01" class="srcb static"><i class="far fa-copy fa-fw"></i></a>
    </div>
