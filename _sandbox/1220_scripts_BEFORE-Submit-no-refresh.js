...
/* show passwords */
$("div#showLoginPass").click(function(){
...
$("div#showSignupPass").click(function(){
...
/* drag & drop sorting - sortable */
$(function() {
  $( "#sortable" ).sortable();
  cancel: "li.page-divider"
});
...
document.getElementById("row_order").value = reorder;
}
...
//     var currentAttrValue = $(this).attr('switch');
