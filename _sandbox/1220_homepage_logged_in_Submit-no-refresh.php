...
<form name="urlField" onSubmit="return submitURLFieldForm();">
    ...
    <p>URL</p>
    <input type="text" id="addressfield" name="address"> <a onclick="reset_url();"><i class="fas fa-backspace"></i></a>
...
<form name="reference" method="get" onSubmit="OnSubmitForm();" target="_blank">
  <p>Thesaurus</p>
    ...
    <input type="text" name="q" id="q"> <a onclick="reset_ref();"><i class="fas fa-backspace"></i></a>
...
<div class="tabs">
      ...
      <ul class="tab-links">
          ...
          <li <?php if ($row['page_number'] == "1") { echo "class=\"active\""; }  ?> >
            <!-- AJAX submit form without refresh video: https://www.youtube.com/watch?v=l6E7E6L8o2Y&ab_channel=CodeBoxx -->
            <form method="post" action="">
              <input type="hidden" id="pg1" value="1">
              <input type="submit" class="pg-btn" name="#tab1" value="Page 1">
            </form>
          </li>
          ...
          <li <?php if ($row['page_number'] == "2") { echo "class=\"active\""; }  ?> >
            ...
            <form method="post" action="">
              <input type="hidden" id="pg2" value="2">
              <input type="submit" class="pg-btn" name="#tab2" value="Page 2">
            </form>
          </li>
          ...
          <li <?php if ($row['page_number'] == "3") { echo "class=\"active\""; }  ?> >
            ...
            <form method="post" action="">
              <input type="hidden" id="pg3" value="3">
              <input type="submit" class="pg-btn" name="#tab3" value="Page 3">
            </form>
          </li>
...
<form name="youtube" action="http://www.youtube.com/results" method="get" target="_blank">
