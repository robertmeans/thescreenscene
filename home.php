...
<body onLoad="document.google.gsearch.focus();">
<noscript>
  <style type="text/css">
...
<div class="yt-modal-content">
  <div class="yt-modal-header">
    ...
    <h2>BrowserGadget | Copy &amp; Paste is all</h2>
  </div>

  <div class="yt-modal-wrap">
      <div class="yt-modal-body">

      <iframe id="foo" class="yvideo" width="560" height="315" src="https://www.youtube.com/embed/VrXBovb-2BA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
