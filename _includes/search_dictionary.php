...
<form name="reference" method="get" onSubmit="return OnSubmitFormSwap();" target="_blank">
  <p>Dictionary</p>
    ...
    <div class="srs"><input type="text" id="refsearch"> <a onclick="reset_ref();"><i class="fas fa-backspace"></i></a></div>
    
    <div class="check-group">
    	<div class="chk-ref">
		    <input class="refchk" type="checkbox" name="thesaurus" id="thesaurus">
		    <label for="thesaurus" class="refchk-label">Thesaurus</label>
	    </div>
    </div><!-- .check-group -->
